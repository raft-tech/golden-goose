...
import smFlagImg from "../../assets/uswds-2.9.0/img/us_flag_small.png";
import iconHttpsImg from "../../assets/uswds-2.9.0/img/icon-https.svg";
import iconDotGovImg from "../../assets/uswds-2.9.0/img/icon-dot-gov.svg";


const GovBannerComponent = () => {
  return (
...
export default GovBannerComponent;
